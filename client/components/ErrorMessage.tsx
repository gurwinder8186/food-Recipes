  ...
  return (
    <div className={`error-container ${showError ? 'show-error' : ''}`}>
      ...
      <div className={`error-message ${showError ? 'show' : ''}`}>
        <img className="this-is-fine" src="images/this-is-fine-fine.gif" alt="this is fine dog" />
        <img className="computer" src="images/quantumcomputer.jpg" alt="quantum computer" />
        <h2>TEMP 1,003°C</h2>
